...
function search(type) {	
	...
	gridObj.load({key: key ,'d_start':d_start,'d_end':d_end,"filter_val_1":filter_key_1.trim(),"filter_val_2":filter_key_2.trim(),type:getUrlParam().type});
}
